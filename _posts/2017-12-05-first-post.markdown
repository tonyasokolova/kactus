...
description: Что такое HTTP, как выглядит HTTP-запрос и ответ
---
...
Чтобы понять суть протокола HTTP, надо попробовать обратиться к какому-нибудь веб-ресурсу, посмотреть как выглядит HTTP-запрос.  
